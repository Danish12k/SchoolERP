...
function position() {
  ...
  var elem = this[0], offset2, offsetParent2 = this.offsetParent(), parentOffset = rootNodeRE.test(offsetParent2[0].nodeName) ? { top: 0, left: 0 } : offsetParent2.offset();
...
function offsetParent() {
  return this.map(function() {
    ...
    while (parent && !rootNodeRE.test(parent.nodeName) && d_class_default(parent).css("position") == "static")
...
function find(selector) {
  ...
  if (!selector) result = d_class_default();
    ...
    result = d_class_default(selector).filter(function() {
      var node = this;
...
function closest(selector, context) {
  ...
  this.each(function(_, node) {
    while (node && !(collection ? collection.indexOf(node) >= 0 : d_class_default.matches(node, selector)))
...
var focus2 = { focus: "focusin", blur: "focusout" };
...
function compatible(event, source) {
  if (source || !event.isDefaultPrevented) {
    ...
    if (source.defaultPrevented !== void 0 ? source.defaultPrevented : "returnValue" in source ? source.returnValue === false : source.getPreventDefault && source.getPreventDefault())
...
function createProxy(event) {
  ...
  for (key in event)
    if (!ignoreProperties.test(key) && event[key] !== void 0) proxy[key] = event[key];
  ...
  return $this.each(function(_, element) {
    ...
    if (selector) delegator = function(e) {
      ...
      if (match && match !== element) {
        evt = d_class_default.extend(createProxy(e), { currentTarget: match, liveFired: element });
...
function anim(properties, duration, ease, callback, delay) {
  ...
  wrappedCallback = function(event) {
    if (typeof event !== "undefined") {
      ...
      d_class_default(this).off(endEvent, wrappedCallback);
    fired = true;
...
function animate(properties, duration, ease, callback, delay) {
  if (isFunction(duration))
    callback = duration, ease = void 0, duration = void 0;
  if (isFunction(ease))
    callback = ease, ease = void 0;
...
domq_default.extend(PhotoViewer.prototype, { draggable }, { movable }, { resizable });
...
var _MtxPhotoviewer = class _MtxPhotoviewer {
  constructor() {
...
_MtxPhotoviewer.\u0275fac = function MtxPhotoviewer_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MtxPhotoviewer)();
};
_MtxPhotoviewer.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MtxPhotoviewer = _MtxPhotoviewer;
(() => {
...
var _MtxPhotoviewerModule = class _MtxPhotoviewerModule {
};
_MtxPhotoviewerModule.\u0275fac = function MtxPhotoviewerModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MtxPhotoviewerModule)();
};
_MtxPhotoviewerModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _MtxPhotoviewerModule,
  imports: [MtxPhotoviewer],
  exports: [MtxPhotoviewer]
});
_MtxPhotoviewerModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({});
var MtxPhotoviewerModule = _MtxPhotoviewerModule;
(() => {
...
var _c0 = (a0) => ({ index: a0 });
function MediaGalleryComponent_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-grid-tile")(1, "mat-grid-tile-header")(2, "span", 3);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(4, "img", 4);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Gallery Image: ", \u0275$index_12_r2 + 1);
    \u0275\u0275advance();
    \u0275\u0275property("alt", \u0275\u0275interpolate1("Gallery Image ", \u0275$index_12_r2 + 1))("mtxPhotoviewerItems", ctx_r2.images)("mtxPhotoviewerOptions", \u0275\u0275pureFunction1(6, _c0, \u0275$index_12_r2))("src", image_r1.src, \u0275\u0275sanitizeUrl);
  }
}
var _MediaGalleryComponent = class _MediaGalleryComponent {
  constructor() {
    this.dir = "images/pixabay/";
    this.images = [];
  }
  ngOnInit() {
    for (let i = 1; i <= 20; i++) {
...
_MediaGalleryComponent.\u0275fac = function MediaGalleryComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MediaGalleryComponent)();
};
_MediaGalleryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MediaGalleryComponent, selectors: [["app-media-gallery"]], decls: 9, vars: 0, consts: [[1, "bg-rose-70"], ["href", "https://github.com/nzbin/photoviewer", "target", "_blank"], ["cols", "4", "rowHeight", "1:1"], ["matLine", ""], ["mtxPhotoviewer", "", 1, "w-full", "h-full", "object-cover", "cursor-pointer", 3, "mtxPhotoviewerItems", "mtxPhotoviewerOptions", "src", "alt"]], template: function MediaGalleryComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "page-header", 0);
    \u0275\u0275elementStart(1, "p");
    \u0275\u0275text(2, " The media pictures are powered by ");
    \u0275\u0275elementStart(3, "a", 1);
    \u0275\u0275text(4, "PhotoViewer");
    \u0275\u0275elementEnd();
    \u0275\u0275text(5, ", you can click the picture to enlarge it.\n");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "mat-grid-list", 2);
    \u0275\u0275repeaterCreate(7, MediaGalleryComponent_For_8_Template, 5, 8, "mat-grid-tile", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(7);
...
}, dependencies: [MatGridListModule, MatGridList, MatGridTile, MatGridTileText, MatLine, MatGridTileHeaderCssMatStyler, MatLineModule, MtxPhotoviewerModule, MtxPhotoviewer, PageHeaderComponent], encapsulation: 2 });
var MediaGalleryComponent = _MediaGalleryComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MediaGalleryComponent, [{
    type: Component,
    args: [{ selector: "app-media-gallery", imports: [MatGridListModule, MatLineModule, MtxPhotoviewerModule, PageHeaderComponent], template: '<page-header class="bg-rose-70" />\r\n\r\n<p>\r\n  The media pictures are powered by\r\n  <a href="https://github.com/nzbin/photoviewer" target="_blank">PhotoViewer</a>,\r\n  you can click the picture to enlarge it.\r\n</p>\r\n\r\n<mat-grid-list cols="4" rowHeight="1:1">\r\n  @for (image of images; track image; let i = $index) {\r\n    <mat-grid-tile>\r\n      <mat-grid-tile-header>\r\n        <span matLine>Gallery Image: {{ i+1 }}</span>\r\n      </mat-grid-tile-header>\r\n      <img class="w-full h-full object-cover cursor-pointer"\r\n        mtxPhotoviewer\r\n        [mtxPhotoviewerItems]="images"\r\n        [mtxPhotoviewerOptions]="{ index: i }"\r\n        [src]="image.src" alt="Gallery Image {{ i+1 }}" />\r\n    </mat-grid-tile>\r\n  }\r\n</mat-grid-list>\r\n' }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MediaGalleryComponent, { className: "MediaGalleryComponent", filePath: "src/app/routes/media/gallery/gallery.component.ts", lineNumber: 14 });
})();

// src/app/routes/media/media.routes.ts
var routes = [{ path: "gallery", component: MediaGalleryComponent }];
export {
  routes
};
//# sourceMappingURL=chunk-Q4ZHEL4D.js.map
