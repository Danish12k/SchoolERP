...
var _NativeDatetimeAdapter = class _NativeDatetimeAdapter extends DatetimeAdapter {
  constructor() {
    super();
  ...
  getWeek(date, firstDayOfWeek) {
    ...
    const daysDiff = Math.floor(timeDiff / (24 * 60 * 60 * 1e3));
...
_NativeDatetimeAdapter.\u0275fac = function NativeDatetimeAdapter_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NativeDatetimeAdapter)();
};
_NativeDatetimeAdapter.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _NativeDatetimeAdapter,
  factory: _NativeDatetimeAdapter.\u0275fac
});
var NativeDatetimeAdapter = _NativeDatetimeAdapter;
(() => {
...
var _NativeDatetimeModule = class _NativeDatetimeModule {
};
_NativeDatetimeModule.\u0275fac = function NativeDatetimeModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NativeDatetimeModule)();
};
_NativeDatetimeModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _NativeDatetimeModule,
  imports: [NativeDateModule]
});
_NativeDatetimeModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
  providers: [{
...
var NativeDatetimeModule = _NativeDatetimeModule;
(() => {
...
var _MtxNativeDatetimeModule = class _MtxNativeDatetimeModule {
};
_MtxNativeDatetimeModule.\u0275fac = function MtxNativeDatetimeModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MtxNativeDatetimeModule)();
};
_MtxNativeDatetimeModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _MtxNativeDatetimeModule
});
_MtxNativeDatetimeModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
  providers: [provideNativeDatetimeAdapter()]
});
var MtxNativeDatetimeModule = _MtxNativeDatetimeModule;
(() => {
...
var _MtxToObservablePipe = class _MtxToObservablePipe {
  transform(value) {
    return isObservable(value) ? value : of(value);
  }
};
_MtxToObservablePipe.\u0275fac = function MtxToObservablePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MtxToObservablePipe)();
};
_MtxToObservablePipe.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
  name: "toObservable",
  type: _MtxToObservablePipe,
  pure: true
});
var MtxToObservablePipe = _MtxToObservablePipe;
(() => {
...
var _MtxIsTemplateRefPipe = class _MtxIsTemplateRefPipe {
  transform(obj) {
    return obj instanceof TemplateRef;
  }
};
_MtxIsTemplateRefPipe.\u0275fac = function MtxIsTemplateRefPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MtxIsTemplateRefPipe)();
};
_MtxIsTemplateRefPipe.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({
  name: "isTemplateRef",
  type: _MtxIsTemplateRefPipe,
  pure: true
});
var MtxIsTemplateRefPipe = _MtxIsTemplateRefPipe;
(() => {
...
var _MtxPipesModule = class _MtxPipesModule {
};
_MtxPipesModule.\u0275fac = function MtxPipesModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MtxPipesModule)();
};
_MtxPipesModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
...
_MtxPipesModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
  imports: [CommonModule]
});
var MtxPipesModule = _MtxPipesModule;
(() => {
...
//# sourceMappingURL=chunk-RTBK2CJR.js.map
